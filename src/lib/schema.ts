...
export const routeAnalytics = pgTable(
  ...
  (table) => ({
    ...
    dateIdx: index("route_analytics_date_idx").on(table.date),
    uniqueAnalyticsRouteDate: uniqueIndex("unique_analytics_route_date").on(
      table.analyticsId,
      table.route,
      table.date
    ),
...
export const countryAnalytics = pgTable(
  ...
  (table) => ({
    ...
    dateIdx: index("country_analytics_date_idx").on(table.date),
    uniqueAnalyticsCountryDate: uniqueIndex("unique_analytics_country_date").on(
      table.analyticsId,
      table.countryCode,
      table.date
    ),
...
export const deviceAnalytics = pgTable(
  ...
  (table) => ({
    ...
    dateIdx: index("device_analytics_date_idx").on(table.date),
    uniqueAnalyticsDeviceDate: uniqueIndex("unique_analytics_device_date").on(
      table.analyticsId,
      table.deviceType,
      table.date
    ),
...
export const osAnalytics = pgTable(
  ...
  (table) => ({
    ...
    dateIdx: index("os_analytics_date_idx").on(table.date),
    uniqueAnalyticsOSDate: uniqueIndex("unique_analytics_os_date").on(
      table.analyticsId,
      table.osName,
      table.date
    ),
...
export const sourceAnalytics = pgTable(
  ...
  (table) => ({
    ...
    dateIdx: index("source_analytics_date_idx").on(table.date),
    uniqueAnalyticsSourceDate: uniqueIndex("unique_analytics_source_date").on(
      table.analyticsId,
      table.sourceName,
      table.date
    ),
